...
dirname='C:\Users\Felix\code\autoCalibrationProject\movies\04-Jun-2015_1\frames\';
for i=648:1452    
load([dirname,num2str(i),'.mat']);
delete([dirname,num2str(i),'.mat']);
save(['C:\Users\Felix\code\autoCalibrationProject\movies\04-Jun-2015_1\frames\',num2str(i-647),'.mat'],'frame');
end
