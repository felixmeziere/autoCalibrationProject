classdef KnobsDistance < PerformanceCalculator
    ...
    methods
        ...
        function [result, result_in_percentage] = calculate_error(obj)
            error_vector=zeros(size(obj.algorithm_box.knobs.
                                                        ...
                                                        %             error=0;
                                                        %             for i=1:size(knobs.knob_groups,2)
            ...
            obj.error_in_percentage=100*result./obj.result_from_pems(good_indices_mask));
